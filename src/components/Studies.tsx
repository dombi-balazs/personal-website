...
function Studies() {
    return(
<div className="text-box justified animate-on-scroll">
    <section id="studies">
          ...
          <ul>
            ...
            <p>Languages: 🛠️ C#, 🧮 F#, 🌐 TypeScript</p>
            <p>
              Frameworks and libraries: ASP.NET, ML.NET, MAUI, WinUI3, React
            </p>
            <p>Developer environments: Visual Studio, Visual Studio Code</p>
            <p>Other technologies: Git, NodeJS, Bun, Vite</p>
          </ul>
